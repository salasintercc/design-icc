...
export default function TemplateICBlueProfessionalV2() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "rgb(77,77,77)", color: IC.gray80, overflowX: "clip" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="flex flex-col gap-10">
            <div>
              ...
              <h2 className="font-bold leading-[1.1] mb-5" style={{ fontSize: "clamp(26px,6.6vw,35px)", color: "#4D4D4D", letterSpacing: "-0.015em" }}>Turn data into revenue. Predict what's next.</h2>
              <div className="w-7 h-[2px] mb-6" style={{ background: IC.blue }} />
              <p className="text-[14px] leading-[1.8] mb-6" style={{ color: "#7F7F7F" }}>We combine market data, big data analytics, and AI-driven forecasts to identify growth opportunities, optimize pricing, and improve sales performance - with practical strategies and tools you can actually implement.</p>
              <div className="flex items-center gap-0">
                <input
                  placeholder="Industry Report Search"
                  className="flex-1 h-12 px-4 text-[14px] outline-none placeholder:text-[#999999]"
                  style={{
                    color: "#C2C2C2",
                    background: IC.white,
                    border: "none",
